...
export default function Categories() {
  ...
  return (
    <>
      {categories.length === 0 && <Box>
        <Typography>Aucune catégorie pour le moment, retournez à <RouterLink to="/">l'accueil.</RouterLink></Typography>
      </Box>}
      {categories.length !== 0 && <Box sx={{ borderTop: ' thick double #117A5D', padding: '25px 0 50px 0' }}>
        <Typography
          variant='h4'
